    ...
    <div className="bg-gray-300 grid md:grid-cols-2 gap-10 items-center p-6 md:p-12">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div
            data-aos="fade-up"
            className="flex items-center gap-3 bg-gray-400 p-3 rounded-lg w-fit"
          >
            <FaQuoteLeft className="text-red-500 text-lg" />
            <p className="italic text-white">
              Your life really depends on bystanders because the most they can
              do is get you in a car
            </p>
          </div>
        </div>
        ...
        <p data-aos="fade-up" className="text-gray-800 leading-relaxed">
          ...
          basic first aid. It's crazy when you hear about someone dying and it
          was something simple that could have ben prevented.
        </p>
